...
def Mod_contact(leg_no, leg_pos1, leg_pos2_y):
    ...
    elif leg_no==3 or leg_no==4: #check axisss
...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        legfix_initial_hip = leg_pos1_hip[0]
        legvar_initial_hip = leg_pos2_hip[0]
        legfix_initial_cg = leg_pos1_cg
        ...
        legvar_initial_hip = leg_pos4_hip[0]
        legfix_initial_cg = leg_pos3_cg
        legvar_initial_cg = leg_pos4_cg
