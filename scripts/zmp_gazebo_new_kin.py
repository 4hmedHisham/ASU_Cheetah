    ...
    if pair_no==1 :    #odd number pair 
        ...
        while(1):
            ...
            if ((current - last_fix) > sample_time_f ) and i < steps:        
                ...
                # set_angle(7 , hip3)
                # set_angle(8, knee3)
                send_ik_point(x_fixed[i],112.75,y_fixed[i],0)  
                # Move Body     
                send_ik_point(xnew[i],112.75,ynew[i],2)                                                 
        ...
        while(1):
            ...
            if ((current - last_fix) > sample_time_f ) and i < steps:        
                ...
                #Publish Fixed leg point
                send_ik_point(x_fixed[i],112.75,y_fixed[i],1)  
                ...
                # set_angle(11, knee4) 
                # Move Body         
                send_ik_point(xnew[i],112.75,ynew[i],3)                 
